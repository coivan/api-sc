package com.ico.apisalvacents.config;
...
import com.ico.apisalvacents.dto.AuthorDTO;
import com.ico.apisalvacents.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c2 = new CommentDTO("Aproveite as férias", sdf.parse("22/03/2018"), new AuthorDTO(bob));
